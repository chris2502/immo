...
OpenLayers.Tile.MarkerTile = OpenLayers.Class(OpenLayers.Tile, {
    ...
    initialize: function(layer, position, bounds, url, size) {
        ...
        this.url = url;        
        this.features = [];
        this.params = this.layer.getParams(bounds);
    },
    ...
    draw: function() {
        ...
        this.params = this.layer.getParams(this.bounds);
    ...
    */
    loadFeaturesForRegion:function(success, failure) {
         OpenLayers.Request.POST({url: this.url, 
                                 success: success, 
                                 failure: failure, 
                                 data: OpenLayers.Util.getParameterString(this.params),
                                 headers: {
